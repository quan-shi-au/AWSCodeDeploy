...
$aolWebSiteName = "AolWeb"
$iisHostName = "aol.safecentral.com"
$directoryPath = "c:\inetpub\wwwroot\AolWeb"
...
Set-ItemProperty IIS:\AppPools\WontokAppPool -name processModel -value @{userName="wtkappadmin";password="9?qsRRK]J]";identitytype=3}
...
if (Test-Path $aolWebSiteName -pathType container)
{
    return
}
...
$iisApp = New-Item $aolWebSiteName -bindings $iisAppName_bindings -physicalPath $directoryPath
